...
public class GridGamePlayerTwo extends View{
    ...
    private int playerOneLife = 17;

    public GridGamePlayerTwo(Context context) {
        this(context, null);
    }

    public GridGamePlayerTwo(Context context, AttributeSet attrs) {
        super(context, attrs);
        blackPaint.setStyle(Paint.Style.FILL_AND_STROKE);
    }

    public void setTabPlayerOne(boolean[][] tabPlayerTwo) {
        this.tabPlayerOne = tabPlayerTwo;
    }
